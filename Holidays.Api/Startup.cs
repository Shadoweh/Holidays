...
using Holidays.Api.Repositories;
using Holidays.Api.Services;
...
namespace Holidays.Api
{
    public class Startup
    {
        ...
        {
            services.AddHttpClient<IHolidayRepository, HolidayRepository>(c => c.BaseAddress = new Uri("https://kayaposoft.com/enrico/json/v2.0"));
